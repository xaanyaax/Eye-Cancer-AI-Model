                    ...
                    <div className="px-8 py-6 space-y-6">
                        ...
                        <div className="space-y-2">
                            ...
                            <input
                                ...
                                className={`w-full px-4 py-2 border rounded-md focus:ring-2 focus:ring-blue-500 transition-colors ${errors.fullName ? 'border-red-500 focus:border-red-500' : 'border-gray-300 focus:border-blue-500'
                                    }`}
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-2">
                                ...
                                <input
                                    ...
                                    onChange={handleInputChange}
                                    className={`w-full px-4 py-2 border rounded-md focus:ring-2 focus:ring-blue-500 transition-colors ${errors.dateOfBirth ? 'border-red-500 focus:border-red-500' : 'border-gray-300 focus:border-blue-500'
                                        }`}
                                />
                                {errors.dateOfBirth && (
                            ...
                            <div className="space-y-2">
                                ...
                                <select
                                    ...
                                    onChange={handleInputChange}
                                    className={`w-full px-4 py-2 border rounded-md focus:ring-2 focus:ring-blue-500 transition-colors ${errors.gender ? 'border-red-500 focus:border-red-500' : 'border-gray-300 focus:border-blue-500'
                                        }`}
                                >
                        ...
                        <div className="space-y-2">
                            ...
                            <input
                                ...
                                onChange={handleInputChange}
                                className={`w-full px-4 py-2 border rounded-md focus:ring-2 focus:ring-blue-500 transition-colors ${errors.phoneNumber ? 'border-red-500 focus:border-red-500' : 'border-gray-300 focus:border-blue-500'
                                    }`}
                        ...
                        <div className="space-y-2">
                            ...
                            <textarea
                                ...
                                onChange={handleInputChange}
                                rows={3}
                                className={`w-full px-4 py-2 border rounded-md focus:ring-2 focus:ring-blue-500 transition-colors ${errors.address ? 'border-red-500 focus:border-red-500' : 'border-gray-300 focus:border-blue-500'
                                    }`}
                                ...
                                {["Left", "Right", "Both"].map((side) => (
                                    <label key={side}>
                                        <input
                                            type="radio"
                                            name="eyeSide"
                                            value={`${side} Eye`} // ✅ CHANGE THIS
                                            checked={formData.eyeSide === `${side} Eye`} // ✅ CHANGE THIS
                                            onChange={() => handleEyeSideChange(`${side} Eye`)} // ✅ CHANGE THIS
                                        />
                                        <span>{side} Eye</span>
                                    </label>
                                ))}
                        ...
                        <div className="pt-6 border-t border-gray-200">
                            <button
                                ...
                                className={`w-full py-3 px-6 rounded-md font-medium transition-colors focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 ${isSubmitting
